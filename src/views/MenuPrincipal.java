...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Leandro Romano © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int msj = JOptionPane.showConfirmDialog(null,"¿Desea salir del sistema?","Confirmar", JOptionPane.YES_NO_OPTION);
				if(msj == 0) {
					System.exit(0);
				}
			}
