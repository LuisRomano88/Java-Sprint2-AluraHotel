...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNreserva.setText(reservasView.generaNumeroReserva());
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
					...
					JOptionPane.showMessageDialog(null, "Reserva Nro "+txtNreserva.getText()+" guardado exitosamente");
	...
	public void guardarHuespedes() throws SQLException{
		
			
		String fechaNacimiento = ((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		int numeroReserva = Integer.parseInt(txtNreserva.getText().toString());
		Huespedes huesped= new Huespedes(txtNombre.getText(),
										  txtApellido.getText(),
	...
	public void validarDatos() {
		...
		if(txtFechaN.getDate() == null) {
			JOptionPane.showMessageDialog(null, "Debe completar la fecha");
		}
